 ...
 * Block 类型枚举
 */
export type BlockType = 'paragraph' | 'heading_1' | 'heading_2' | 'heading_3' | 'bulleted_list_item' | 'numbered_list_item' | 'to_do' | 'toggle' | 'quote' | 'callout' | 'image' | 'video' | 'file' | 'pdf' | 'bookmark' | 'code' | 'equation' | 'divider' | 'table_of_contents' | 'breadcrumb' | 'child_page' | 'child_database' | 'embed' | 'link_preview' | 'synced_block' | 'table' | 'table_row' | 'column_list' | 'column';
/**
 * 富文本注释
 */
...
//# sourceMappingURL=flowus.d.ts.map